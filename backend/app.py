...
NORMALIZE = {
    "frontend": [
        ...
        "tailwind", "bootstrap", "sass", "redux",
        "vite", "webpack", "jquery"
    ],

    "backend": [
        "nodejs", "express", "flask", "django",
        "fastapi", "spring", "laravel", "php",
        "java", "python", "golang", "ruby",
        "rails", "dotnet", "csharp", "rest",
        "graphql", "apis", "server"
    ],

    "database": [
        "postgresql", "mysql", "mongodb", "sqlite",
        "redis", "firebase", "oracle", "mariadb",
        "cassandra", "dynamodb", "supabase"
    ],

    "devops": [
        "docker", "kubernetes", "jenkins",
        "githubactions", "ci/cd", "nginx",
        "aws", "gcp", "azure", "linux",
        "terraform", "ansible"
    ],
    ...
    "mobile": [
        "flutter", "reactnative", "android",
        "kotlin", "swift", "ios"
    ],

    "authentication": [
        "jwt", "oauth", "auth", "authentication",
        "bcrypt", "firebaseauth"
    ],

    "testing": [
        "jest", "pytest", "selenium",
        "cypress", "unittest", "postman"
    ],
...
STOP_SKILLS = {
    "experience", "work", "role", "roles", "job",
    "position", "career", "professional", "skills",
    "skill", "knowledge", "understanding", "expertise",
    "responsibilities", "responsibility",

    "company", "organization", "team", "teams",
    "client", "clients", "business", "businesses",
    "candidate", "candidates", "employee", "employees",

    "developer", "development", "engineer", "engineering",
    "applications", "application", "systems", "system",
    "software", "platform", "solution", "solutions",
    "project", "projects", "service", "services",

    "design", "designed", "building", "built",
    "working", "worked", "creating", "created",
    "implementation", "implemented", "management",
    "managing", "support", "supported",

    "resume", "cv", "summary", "objective",
    "profile", "details", "description",

    "intern", "internship", "stipend", "benefits",
    "opportunity", "opportunities", "deadline",
    "duration", "location", "employment",

    "communication", "leadership", "passionate",
    "motivated", "creative", "responsible",
    "collaboration", "collaborate",

    "use", "using", "used", "based",
    "including", "related", "focused",
    "ability", "abilities",
